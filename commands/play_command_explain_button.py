...
class ExplainButtonView(discord.ui.View):
    ...
    async def callback_return_button(self, interaction : discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(description="Ce bouton retourne a la musique precedente", color=discord.Color.blue())
    ...
    async def callback_stop_button(self, interaction : discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(description="Ce bouton arrete la musique", color=discord.Color.blue())
        await interaction.response.send_message(embed=embed, ephemeral=True, delete_after=5)
    ...
    async def callback_pause_button(self, interaction : discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(description="Ce bouton met la musique en pause", color=discord.Color.blue())
        await interaction.response.send_message(embed=embed,ephemeral=True, delete_after=5)
    ...
    async def callback_skip_button(self, interaction : discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(description="Ce bouton passe a la musique suivante", color=discord.Color.blue())
        await interaction.response.send_message(embed=embed,ephemeral=True, delete_after=5)
    ...
    async def callback_disable_autoplay_button(self, interaction : discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(description="Ce bouton désactive le mode DJ ou active le mode DJ", color=discord.Color.blue())
        await interaction.response.send_message(embed=embed, ephemeral=True, delete_after=5)
    ...
    async def callback_low_volume_button(self, interaction : discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(description="Ce bouton diminue le sons de la musique de 10% sur 150%", color=discord.Color.blue())
        await interaction.response.send_message(embed=embed, ephemeral=True, delete_after=5)
    ...
    async def callback_high_volume_button(self, interaction : discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(description="Ce bouton augmente le sons de la musique de 10% sur 150%", color=discord.Color.blue())
        await interaction.response.send_message(embed=embed, ephemeral=True, delete_after=5)
...
class Play_command_explain_button(commands.Cog):
    ...
    async def explain_play_button(self, ctx: commands.Context):
        ...
        embed = discord.Embed(title="Explain button", description="clickez sur le bouton pour savoir son utilité", color=discord.Color.blue())
